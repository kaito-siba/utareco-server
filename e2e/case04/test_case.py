...
def run_case04_test() -> bool:
    """CASE04のテストを実行する.

    すべてカラオケ音源での重複無し総当たり組み合わせテスト
    ...
    # テストファイル（すべてカラオケ音源）
    test_files = {
        "eine_kleine_1": dataset_dir / "Eine_Kleine_karaoke_1.wav",
        "eine_kleine_2": dataset_dir / "Eine_Kleine_karaoke_2.wav",
    ...
    expected_same_pairs = {
        ("eine_kleine_1", "eine_kleine_2"),  # 同一楽曲の異なるカラオケ録音
    }
    ...
    if same_song_tests:
        ...
        print(
            f"同一楽曲判定: {same_passed}/{len(same_song_tests)} "
